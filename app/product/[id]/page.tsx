              ...
              <div className="product-gallery">
                ...
                <div className="main-image-wrapper">
                  <div className="image-zoom-container">
                    <a
                      href="/img/product/product-9.webp"
                      className="glightbox"
                    ...
                    >
                      <img
                        ...
                        data-zoom="/img/product/product-9.webp"
                      />
              ...
              <div className="product-info-wrapper" id="product-info-sticky">
                ...
                <div className="product-meta">
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    <span className="product-category">Headphones</span>
            ...
            <div className="container">
              <div className="sticky-content">
                <div className="product-preview">
                  <img
                    src="/img/product/product-details-1.webp"
                    alt="Product"
                    ...
                    <div className="accordion-body">
                      <div className="product-description">
                        ...
                        <p>
                          ...
                          imperdiet venenatis. Suspendisse vulputate quam diam,
                          et consectetur augue condimentum in. Aenean dapibus
                          urna eget nisi pharetra, in iaculis nulla blandit.
                          Praesent at consectetur sem, sed sollicitudin nibh. Ut
                          interdum risus ac nulla placerat aliquet.
                        </p>
                        ...
                        <div className="row mt-4">
                          <div className="col-md-6">
                            ...
                            <ul className="feature-list">
                              <li>
                                <i className="bi bi-check-circle"></i> Lorem
                              ...
                              <li>
                                <i className="bi bi-check-circle"></i>
                                Suspendisse vulputate quam diam, et consectetur
                                augue
                              </li>
                              <li>
                          ...
                          <div className="col-md-6">
                            ...
                            <ul className="feature-list">
                              <li>
                                <i className="bi bi-box"></i> Lorem Ipsum
                                Wireless Headphones
                              </li>
                              <li>
                              ...
                              <li>
                                <i className="bi bi-box"></i> USB-C Charging
                                Cable
                              </li>
                              <li>
                        ...
                        <div className="reviews-list">
                          ...
                          <div className="review-item">
                            <div className="review-header">
                              <div className="reviewer-info">
                                <img
                                  src="/img/person/person-f-2.webp"
                                  alt="Reviewer"
                                  className="reviewer-avatar"
                                />
                                <div>
                          ...
                          <div className="review-item">
                            <div className="review-header">
                              <div className="reviewer-info">
                                <img
                                  src="/img/person/person-m-3.webp"
                                  alt="Reviewer"
                                  className="reviewer-avatar"
                                />
                                <div>
