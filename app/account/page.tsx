      ...
      <section id="account" className="account section">
        <div className="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div className="row">
            {/* Profile Sidebar */}
            <div
              className="col-lg-3 profile-sidebar collapse d-lg-block"
              id="profileSidebar"
              data-aos="fade-right"
              data-aos-delay="200"
            >
            ...
            {/* Profile Content */}
            <div
              className="col-lg-9 profile-content"
              data-aos="fade-left"
              data-aos-delay="300"
            >
                  ...
                  <div className="orders-table">
                    <div className="table-header">
                      <div className="row">
                        <div className="col-md-3">
                          <div className="sort-header">Order #</div>
                        </div>
                        <div className="col-md-3">
                        ...
                        <div className="col-md-3">
                          <div className="sort-header">Status</div>
                        </div>
                        <div className="col-md-3">
                          <div className="sort-header">
                            Total
                    ...
                    <div className="order-items">
                      ...
                      <div className="order-item">
                        <div className="row align-items-center">
                          <div className="col-md-3">
                            <div className="order-id">112P45A90V2</div>
                          </div>
                          <div className="col-md-3">
                            <div className="order-date">05/18/2024</div>
                          </div>
                          <div className="col-md-3">
                            <div className="order-status delivered">
                              <span className="status-dot"></span>
                        ...
                        <div className="collapse order-details" id="orderDetails5">
                          <div className="order-details-content">
                            <div className="order-details-header">
                              <h5>Order Details</h5>
                              <div className="order-info">
                                <div className="info-item">
                                  <span className="info-label">Order Date:</span>
                                  <span className="info-value">05/18/2024</span>
                                </div>
                                <div className="info-item">
                                  <span className="info-label">
                                    Payment Method:
                      ...
                      <div className="order-item">
                        <div className="row align-items-center">
                          <div className="col-md-3">
                            <div className="order-id">28BA67U0981</div>
                          </div>
                          <div className="col-md-3">
                            <div className="order-date">04/03/2024</div>
                          </div>
                          <div className="col-md-3">
                            <div className="order-status canceled">
                              <span className="status-dot"></span>
                        ...
                        <div className="order-products">
                          <div className="product-thumbnails">
                            ...
                            />
                            <img
                              src="/img/product/product-1-variant.webp"
                              alt="Product"
                              className="product-thumb"
                              loading="lazy"
                            />
                        ...
                        <div className="collapse order-details" id="orderDetails6">
                          <div className="order-details-content">
                            <div className="order-details-header">
                              <h5>Order Details</h5>
                              <div className="order-info">
                                <div className="info-item">
                                  <span className="info-label">Order Date:</span>
                                  <span className="info-value">04/03/2024</span>
                                </div>
                                <div className="info-item">
                                  <span className="info-label">
                                    Payment Method:
                            ...
                            <div className="cancellation-info mt-3">
                              <h6>Cancellation Reason</h6>
                              <p>
                                Order was canceled at customer&apos;s request.
                                Items were not in stock at the time of processing.
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    >
                      ...
                      <div className="review-content">
                        <p>
                          ...
                          nisl nisl aliquam nisl, eget ultricies nisl nisl eget
                          nisl.
                        </p>
                      </div>
                    ...
                    <div className="notification-group">
                      ...
                      <div className="notification-item">
                        <div className="notification-info">
                          ...
                          <div className="notification-desc">
                            Receive notifications about shipping and delivery
                          </div>
                        </div>
                        <div className="form-check form-switch">
                          <input
                    ...
                    <div className="notification-group">
                      ...
                      <div className="notification-item">
                        <div className="notification-info">
                          ...
                          <div className="notification-desc">
                            Receive notifications about security-related activity
                          </div>
                        </div>
                        <div className="form-check form-switch">
                          <input
                    ...
                    <div className="notification-group">
                      ...
                      <div className="notification-item">
                        <div className="notification-info">
                          ...
                          <div className="notification-desc">
                            Receive notifications with product recommendations
